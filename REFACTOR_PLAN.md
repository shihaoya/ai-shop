...
|------|------|------|----------|----------|------|
| 阶段0 | 环境准备 | 已完成 | 2026-05-18 | 2026-05-18 | 删除旧测试、创建目录结构 |
| 阶段0.5 | 单元测试准备 | 已完成 | 2026-05-18 | 2026-05-18 | 编写AuthServiceTest及必要的DTO/Mapper |
...
| 阶段5 | 后端验证 | 已完成 | 2026-05-18 | 2026-05-18 | 启动成功、Docker测试通过 |
| 阶段6 | 前端API重组 | 已完成 | 2026-05-18 | 2026-05-18 | 按模块重组api/，保持向后兼容 |
| 阶段7 | 前端Views重组 | 已完成 | 2026-05-18 | 2026-05-18 | 按模块重组views/，更新路由配置 |
| 阶段8 | 最终验证 | 已完成 | 2026-05-18 | 2026-05-18 | 后端编译/测试通过、前端构建通过 |
