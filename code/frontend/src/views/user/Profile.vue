...
import { getInviteCode as adminGetInviteCode, createInviteCode as adminCreateInviteCode } from '@/api/modules/admin'
import { getInviteCode as operatorGetInviteCode, createInviteCode as operatorCreateInviteCode } from '@/api/modules/operator'
