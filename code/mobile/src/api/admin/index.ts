...
import type { PageRequest, Shop, UserInfo } from '@/types'
...
// 获取用户积分流水
export function getUserPointsLog(userId: string | number, params: PageRequest): Promise<ListResponse<any>> {
  return request.get<ListResponse<any>>(`/admin/users/${userId}/points/log`, { params }) as any
}